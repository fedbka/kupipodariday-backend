export const OFFERS_AMOUNT_DESCRIPTION = 'Сумма заявки';
export const OFFERS_AMOUNT_EXAMPLE = '1549.43';
export const OFFERS_HIDDEN_DESCRIPTION = 'Признак скрытой заявки';
export const OFFERS_HIDDEN_EXAMPLE = 'false';
...
export const OFFERS_ERROR_MESSAGE_OVERRAISED = 'Сумма заявки превышает необходимый максимум';
export const OFFERS_ERROR_MESSAGE_RAISEENDED = 'Сбор средств завершен ранее';